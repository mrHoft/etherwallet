  ...
  <div class="passphrase-component" @click="focusInput">
    <div class="passphrase-boxes">
      <div
        ...
        :key="index"
        ref="charBoxRefs"
        :class="['char-box', { focused: focusedIndex === index }]"
        @click.stop="setFocusAtIndex(index)"
      >
        {{ char }}
      </div>
    </div>
    ...
    >
      <svg v-if="isVisible" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
